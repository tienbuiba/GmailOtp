...
export default function DashboardSidebar({ isOpenSidebar, onCloseSidebar }) {
  ...
  const navConfig = [
    ...
    {
      title: t("dashboard_002"),
      path: '/dashboard/user',
      icon: getIcon('fluent:folder-mail-16-regular'),
    },
    {
      title: t("rent mail"),
      path: '/dashboard/rent-mail',
      icon: getIcon('fluent:chat-mail-20-regular'),
    },
    {
      title: t("dashboard_003"),
      path: '/dashboard/deposit',
      icon: getIcon('dashicons:money-alt')
    },
    {
      title: t("dashboard_005"),
      path: '/dashboard/transaction-order',
      icon: getIcon('icon-park-outline:buy')
    },
    {
      title: t("dashboard_004"),
